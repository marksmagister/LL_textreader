...
-- no ambient current user anywhere below this line. See docs/decisions/0021.
...
-- Identity is Google's (docs/decisions/0021). `google_sub` is the key and an
...
-- ---------------------------------------------------------------- accounts
-- See docs/decisions/0021. Identity is Google's; what lives here is the session
